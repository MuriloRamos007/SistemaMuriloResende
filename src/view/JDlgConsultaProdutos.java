...
public class JDlgConsultaProdutos extends javax.swing.JDialog {
     ...
     */
    private ControllerConsultasProdutos controllerConsultasProdutos;
    ...
    public JDlgConsultaProdutos(java.awt.Frame parent, boolean modal) {
        ...
        List<TbProdutos> lista = produtosDAO.listAll();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (row >= 0) {
                TbProdutos produto = controllerConsultasProdutos.getBean(row);
                dispose();
            }
        }
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (!jTxtValor.getText().isEmpty() && !jTxtNome.getText().isEmpty()) {
            ...
            List<TbProdutos> listaNomeValor = produtosDAO.listNomeValor(nome, valor);
            controllerConsultasProdutos.setList(listaNomeValor);
            
        } else if (!jTxtNome.getText().isEmpty()) {
            String nome = jTxtNome.getText();
            
            List<TbProdutos> listaNome = produtosDAO.listNome(nome);
            controllerConsultasProdutos.setList(listaNome);

            
        } else if (!jTxtValor.getText().isEmpty()){
            double valor = Util.strToDouble(jTxtValor.getText());
            
            List<TbProdutos> listaValor = produtosDAO.listValor(valor);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            PdfWriter.getInstance(
                document,
                new FileOutputStream("relatorio_produtos.pdf")
            );
            document.open();
            ...
            for (int i = 0; i < controllerConsultasProdutos.getRowCount(); i++) {
                TbProdutos p = controllerConsultasProdutos.getBean(i);

                tabela.addCell(String.valueOf(p.getIdProduto()));
                tabela.addCell(p.getNmProduto());
                tabela.addCell(String.format("R$ %.2f", p.getPreco()));
            }
